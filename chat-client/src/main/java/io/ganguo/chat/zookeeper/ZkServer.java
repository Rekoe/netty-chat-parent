...
/**
 * Created by James on 2015/11/17 0017. 这个类是链接ZK服务器。从服务器中获取chat集群服务器的链接
 *
 */
public class ZkServer {
	...
	private static CuratorFramework createCurator(String connectionURL) {
		return CuratorFrameworkFactory.builder().connectString(connectionURL).namespace(SERVER_PATH).connectionTimeoutMs(50000).retryPolicy(new RetryNTimes(Integer.MAX_VALUE, 20000)).sessionTimeoutMs(50000).build();
	}
